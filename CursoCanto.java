...
/**
 * Esta clase representa el curso de canto que implementa las clase {@code Sujeto} y {@code Curso}.
 * @author  
 *    BonziBuddy
 * @since 2025-02-23
 */
public class CursoCanto implements Sujeto, Curso {
     ...
     * 
     * @return un valor entero asosiado a la dificultad del curso actualmente
     */
